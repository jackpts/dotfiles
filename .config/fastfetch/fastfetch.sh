...
IMAGE_PATH="$HOME/.config/fastfetch/she-logo.jpg"

if [ ! -f "$IMAGE_PATH" ]; then
    FETCH="fastfetch --logo-padding 1 --logo-padding-top 0 --logo $IMAGE_PATH"
    eval "$FETCH"
    return 0
fi
...
FETCH="fastfetch --logo-recache $ARGUMENTS --logo $IMAGE_PATH"
eval "$FETCH"
